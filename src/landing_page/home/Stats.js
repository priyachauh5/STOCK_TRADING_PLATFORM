        ...
        <div className='container p-5'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+crore customers trust Stock Trading Paltform with Rs3.5+ lakh crores worth of equity investments.</p>
                    ...
                    <h2 className='fs-4'>The Stock Trading Platform universe</h2>
                    <p className='text-muted'>Not just an app, but a whole ecosystem. Our investments in 30+ fintech startups offer you tailored services speific to your needs.</p>
